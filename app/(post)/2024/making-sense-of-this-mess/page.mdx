...
<div class="flex justify-center">
  <img class="rounded-xl" src="https://huggingface.co/datasets/stevhliu/personal-blog/resolve/main/transformers-docs.png"/>
</div>
<p class="text-xs">The main version of the Transformers documentation today compared to version 4.10.1 from nearly 3 years ago.</p>

As transformer models increasingly became the default way to approach AI, the documentation expanded significantly to include new models and usage patterns. But the new content was added incrementally without really considering how the audience and the Transformers library have evolved.

I think this is the reason the documentation experience (DocX) feels disjointed, difficult to navigate, and outdated. Basically, a mess.

This is why a documentation redesign is necessary to make sense of this mess. The goal is to:
...
3. Create a more unified DocX by *integrating* content rather than *amending* it to the existing documentation. 
...
With the redesign, the documentation will be more code-first and solution-oriented. Code and explanation of machine learning concepts will be tightly coupled to provide a more *complete* and beginner-friendly onboarding experience.
...
One of my first projects at Hugging Face was to align the documentation with [Diátaxis](https://diataxis.fr/), a documentation *approach* based on user needs (learning, solving, understanding, reference).
...
Tree rings provide a climatological record of the past (drought, flood, wildfire, etc.). In a way, the documentation also has its own tree rings or *eras* that capture its evolution:

1. **Not just text** era: Transformer models are for [computer vision](https://hf.co/docs/transformers/tasks/image_classification), [audio](https://hf.co/docs/transformers/tasks/asr), [multimodal](https://hf.co/docs/transformers/tasks/text-to-speech), and not just text.
...
<div class="flex justify-center">
  <img class="rounded-xl" src="https://huggingface.co/datasets/stevhliu/personal-blog/resolve/main/ring-diagram.png"/>
</div>
...
A redesign will help rebalance the overall DocX. Content will feel native and integrated rather than added on.

## Conclusion [#conclusion]

This post explored the reason and motivation behind redesigning the Transformers documentation.

Stay tuned for the next post which identifies the mess in more detail and answers important questions such as, who are the intended users, what is the current state of the content, and how is it being interpreted.
