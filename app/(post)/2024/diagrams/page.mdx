...
2. Experiment with deep and shallow hierarchies for the content.
...
1. At the highest level, you'll find content about the library. Design choices, and how to contribute.
2. The second layer is the core:
...
For example, the training content is mainly composed of 3 substructures: the [transformers.Trainer](https://hf.co/documentation/transformers/main_classes/trainer#transformers.Trainer) API, distributed training, and hardware-specific training.
...
<p class="text-sm">I'll be focusing on actually redesigning the documentation now. I'll be back with more updates once the redesign is complete!</p>