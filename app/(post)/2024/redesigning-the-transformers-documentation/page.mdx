...
<Callout emoji="✦">2/10/25 - Lightly edited and consolidated the other posts into this single post.</Callout>
...
AI moves fast and it's easy to lose sight of what Transformers is. You can interpret the library through a couple lenses.
...
None of these are wrong, but they're each a single facet of Transformers.

> The Transformers library is a library of pretrained models (mostly Transformer architectures but not only).
> - Sylvain Gugger

There can be new modalities, use cases, and APIs, but at the end of the day, Transformers is really a collection of pretrained models you can use for training or inference.

This is the North Star that will guide the redesign.
...
Rigidity prevented natural content structures from emerging and bloated the docs. Docs about one topic soon spanned several sections, because it was what the structure dictated, not because it made sense.
...
<div class="flex justify-center">
  <img class="rounded-xl" src="https://huggingface.co/datasets/stevhliu/personal-blog/resolve/main/ring_diagram.png"/>
</div>
<p class="text-xs">New content is layered progressively over the previous content instead of coexisting as a part of the overall docs.</p>
...
The redesign will help rebalance the overall DocX. Content will feel native and integrated rather than added on.
