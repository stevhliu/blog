...
[Data Studio](https://huggingface.co/docs/hub/data-studio) is available in dataset repositories for exploring data in the browser without downloading it. The built-in SQL console helps analyze a dataset in more detail.
