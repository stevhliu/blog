...
3. Apply the softmax function to convert the attention scores into probabilities that add up to 1.
    ...
    `[e^0.179 / (e^0.179 + e^0.311), e^0.311 / (e^0.179 + e^0.311)]` = `[0.46, 0.54]`
...
[BERT](https://huggingface.co/google-bert/bert-base-uncased) uses MHA.
...
- In the first block, calculate a local max *m<sub>1</sub>* and a sum *l<sub>1</sub>* for Q, K.
