...
export const Tip = ({ text = null, children }: Omit<CalloutProps, 'type' | 'emoji'>) => (
  <Callout type="tip">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-lightbulb-icon lucide-lightbulb w-4 h-4 flex-shrink-0 mr-2 mt-1" aria-hidden="true">
...
export const Warning = ({ text = null, children }: Omit<CalloutProps, 'type'>) => (
  <Callout type="warning">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-alert-icon lucide-circle-alert w-4 h-4 flex-shrink-0 mr-2 mt-1" aria-hidden="true">
