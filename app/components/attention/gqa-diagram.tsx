  ...
  return (
    <figure className="my-8">
      <svg viewBox="0 0 500 240" className="w-full max-w-lg mx-auto">
        {/* Group 1 box */}
        <rect x="20" y="10" width="220" height="220" rx="12" className="fill-violet-50 stroke-violet-200 dark:fill-violet-950 dark:stroke-violet-400" strokeWidth="1.5" strokeDasharray="6,4"/>
        <text x="130" y="32" textAnchor="middle" className="fill-violet-400 text-[11px]">group 1</text>
        
        {/* Group 2 box */}
        <rect x="260" y="10" width="220" height="220" rx="12" className="fill-rose-50 stroke-rose-200 dark:fill-rose-950 dark:stroke-rose-400" strokeWidth="1.5" strokeDasharray="6,4"/>
        <text x="370" y="32" textAnchor="middle" className="fill-rose-400 text-[11px]">group 2</text>
        
        {/* Group 1 Heads */}
        <g transform="translate(35, 42)">
          <g transform="translate(0, 0)">
            <rect x="-3" y="0" width="42" height="58" rx="6" className="fill-white/50 stroke-slate-200 dark:fill-slate-800/50 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="3,2"/>
