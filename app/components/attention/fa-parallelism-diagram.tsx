    ...
    <figure className="my-8">
      <svg viewBox="0 0 420 200" className="w-full max-w-lg mx-auto">
        ...
        <g transform="translate(10, 10)">
          ...
          <text x="90" y="14" textAnchor="middle" className="fill-slate-400 text-[8px]">batch × heads × query blocks</text>
          ...
          <g transform="translate(10, 28)">
            ...
            <text x="18" y="21" textAnchor="middle" className="fill-violet-600 text-[6px]">h0 q0</text>
            ...
            <text x="60" y="21" textAnchor="middle" className="fill-violet-600 text-[6px]">h1 q0</text>
            ...
            <text x="102" y="21" textAnchor="middle" className="fill-violet-600 text-[6px]">h2 q0</text>
            ...
            <text x="144" y="21" textAnchor="middle" className="fill-violet-600 text-[6px]">h3 q0</text>
            ...
            <text x="18" y="55" textAnchor="middle" className="fill-violet-600 text-[6px]">h0 q0</text>
            ...
            <text x="60" y="55" textAnchor="middle" className="fill-violet-600 text-[6px]">h1 q0</text>
            ...
            <text x="102" y="55" textAnchor="middle" className="fill-violet-600 text-[6px]">h2 q0</text>
            ...
            <text x="144" y="55" textAnchor="middle" className="fill-violet-600 text-[6px]">h3 q0</text>
        ...
        <g transform="translate(220, 10)">
          ...
          <text x="90" y="14" textAnchor="middle" className="fill-teal-500 text-[8px]">batch × heads × query blocks</text>
          ...
          <g transform="translate(10, 28)">
            ...
            <text x="18" y="21" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="60" y="21" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="102" y="21" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="144" y="21" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="18" y="55" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="60" y="55" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="102" y="55" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="144" y="55" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="18" y="89" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="60" y="89" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="102" y="89" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="144" y="89" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="18" y="123" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="60" y="123" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
            ...
            <text x="102" y="123" textAnchor="middle" className="fill-teal-600 text-[6px]">q 0</text>
            ...
            <text x="144" y="123" textAnchor="middle" className="fill-teal-600 text-[6px]">q 1</text>
          </g>
          
          <text x="90" y="170" textAnchor="middle" className="fill-teal-500 text-[8px]">16 of 16 SMs used</text>
        </g>
      </svg>
      <Caption>FlashAttention-2 schedules more query blocks in parallel, which improves SM usage for long sequences.</Caption>
    </figure>
  );
}
