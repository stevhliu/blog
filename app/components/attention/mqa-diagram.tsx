    ...
    <figure className="my-8">
      <svg viewBox="0 0 340 180" className="w-full max-w-sm mx-auto">
        ...
        <g transform="translate(20, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 1</text>
        ...
        <g transform="translate(75, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 2</text>
          <rect x="0" y="22" width="40" height="40" rx="6" className="fill-sky-100 stroke-sky-400" strokeWidth="1.5"/>
          <text x="20" y="47" textAnchor="middle" className="fill-sky-600 text-[12px] font-medium">Q₂</text>
        </g>
        ...
        <g transform="translate(130, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 3</text>
          <rect x="0" y="22" width="40" height="40" rx="6" className="fill-sky-100 stroke-sky-400" strokeWidth="1.5"/>
          <text x="20" y="47" textAnchor="middle" className="fill-sky-600 text-[12px] font-medium">Q₃</text>
        </g>
        ...
        <g transform="translate(185, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 4</text>
          <rect x="0" y="22" width="40" height="40" rx="6" className="fill-sky-100 stroke-sky-400" strokeWidth="1.5"/>
          <text x="20" y="47" textAnchor="middle" className="fill-sky-600 text-[12px] font-medium">Q₄</text>
        </g>
        ...
        <g transform="translate(240, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 5</text>
          <rect x="0" y="22" width="40" height="40" rx="6" className="fill-sky-100 stroke-sky-400" strokeWidth="1.5"/>
          <text x="20" y="47" textAnchor="middle" className="fill-sky-600 text-[12px] font-medium">Q₅</text>
        </g>
        ...
        <g transform="translate(295, 10)">
          <rect x="-5" y="0" width="50" height="75" rx="8" className="fill-slate-50 stroke-slate-200 dark:fill-slate-800 dark:stroke-slate-500" strokeWidth="1" strokeDasharray="4,2"/>
          <text x="20" y="14" textAnchor="middle" className="fill-slate-400 dark:fill-slate-400 text-[9px]">head 6</text>
          <rect x="0" y="22" width="40" height="40" rx="6" className="fill-sky-100 stroke-sky-400" strokeWidth="1.5"/>
          <text x="20" y="47" textAnchor="middle" className="fill-sky-600 text-[12px] font-medium">Q₆</text>
        </g>
